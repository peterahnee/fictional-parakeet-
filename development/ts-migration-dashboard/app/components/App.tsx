  ...
  const boxesByModuleId =
    boxRectsByModuleId === null
      ...
      : Object.values(boxRectsByModuleId).reduce<Record<string, BoxModel>>(
          (obj, boxRect) => {
            const dependencyBoxRects = modulesById[
              boxRect.moduleId
            ].dependencyIds.reduce<BoxRect[]>(
            ...
            const dependentBoxRects = modulesById[
              boxRect.moduleId
            ].dependentIds.reduce<BoxRect[]>((dependentBoxes, dependentId) => {
    ...
    <>
      ...
      <details className="help">
        ...
        <div className="help__answer">
          ...
          <p>
            You can hover over a box to see the filename. You can also click on
            a box to see connections between other files;{' '}
            <strong className="module-connection__dependency">red</strong> lines
            are dependencies, while{' '}
      ...
      <div className="partitions">
        ...
        {activeBoxRect === null ? null : (
          <Connections
            boxesByModuleId={boxesByModuleId}
            activeBoxRect={activeBoxRect}
          />
        )}
      </div>
    </>
