...
```jsx
import { Size，TextType } from '../../../helpers/constants/design-system';
import { Icon, ICON_NAMES } from '../../components/component-library';
...
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.inherit} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.iconDefault} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.iconAlternative} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.iconMuted} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.overlayInverse} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.primaryDefault} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.primaryInverse} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.errorDefault />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.errorInverse} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.successDefault} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.successInverse} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.warningDefault} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.warningInverse} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.infoDefault} />
<Icon name={ICON_NAMES.ADD_SQUARE} color={ICON_COLORS.infoInvers} />
```
