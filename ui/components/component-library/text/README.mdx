...
<Text color={TEXT_COLORS.textDefault}>
  text-default
</Text>
<Text color={TEXT_COLORS.textAlternative}>
  text-alternative
</Text>
<Text color={TEXT_COLORS.textMuted}>
  text-muted
</Text>
<Text color={TEXT_COLORS.primaryDefault}>
  primary-default
</Text>
<Text color={TEXT_COLORS.primaryInverse} backgroundColor={BACKGROUND_COLORS.primaryDefault}>
  primary-inverse
</Text>
<Text color={TEXT_COLORS.errorDefault}>
  error-default
</Text>
<Text color={TEXT_COLORS.errorInverse} backgroundColor={BACKGROUND_COLORS.errorDefault}>
  error-inverse
</Text>
<Text color={TEXT_COLORS.successDefault}>
  success-default
</Text>
<Text color={TEXT_COLORS.successInverse} backgroundColor={BACKGROUND_COLORS.successDefault}>
  success-inverse
</Text>
<Text color={TEXT_COLORS.warningDefault}>
  warning-default
</Text>
<Text color={TEXT_COLORS.warningInverse} backgroundColor={BACKGROUND_COLORS.warningDefault}>
  warning-inverse
</Text>
<Text color={TEXT_COLORS.infoDefault}>
  info-default
</Text>
<Text color={TEXT_COLORS.infoInverse} backgroundColor={BACKGROUND_COLORS.infoDefault}>
  info-inverse
</Text>
```
