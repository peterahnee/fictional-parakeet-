...
describe('Box', () => {
  ...
  describe('border', () => {
    ...
    it('should render the Box with the borderColor class', () => {
      const { getByText } = render(
        <Box borderColor={BORDER_COLORS.borderDefault}>Box content</Box>,
      );
      expect(getByText('Box content')).toHaveClass(
    ...
    it('should render the Box with the responsive borderColor classes', () => {
      const { getByText } = render(
        <Box
          borderColor={[
            BORDER_COLORS.borderDefault,
            BORDER_COLORS.errorDefault,
            BORDER_COLORS.infoDefault,
            BORDER_COLORS.warningDefault,
          ]}
        >
          Box content
        </Box>,
  ...
  describe('background', () => {
    it('should render the Box with the backgroundColor class', () => {
      const { getByText } = render(
        <Box backgroundColor={BACKGROUND_COLORS.backgroundDefault}>
          Box content
        </Box>,
      );
      expect(getByText('Box content')).toHaveClass(
    ...
    it('should render the Box with the responsive backgroundColor classes', () => {
      const { getByText } = render(
        <Box
          backgroundColor={[
            BACKGROUND_COLORS.backgroundDefault,
            BACKGROUND_COLORS.errorDefault,
            BACKGROUND_COLORS.infoDefault,
            BACKGROUND_COLORS.warningDefault,
          ]}
        >
          Box content
        </Box>,
  ...
  describe('color', () => {
    it('should render the Box with the color class', () => {
      const { getByText } = render(
        <Box color={TEXT_COLORS.textDefault}>Box content</Box>,
      );
    ...
    it('should render the Box with the responsive color classes', () => {
      const { getByText } = render(
        <Box
          color={[
            TEXT_COLORS.textDefault,
            TEXT_COLORS.primaryDefault,
            TEXT_COLORS.errorDefault,
            TEXT_COLORS.successDefault,
          ]}
        >
          Box content
        </Box>,
